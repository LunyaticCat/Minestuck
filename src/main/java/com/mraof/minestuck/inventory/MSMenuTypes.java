...
public class MSMenuTypes
{
	...
	public static final Supplier<MenuType<StrifeSpecibusMenu>> SPECIBUS_DECK = REGISTER.register("specibus_deck", () -> new MenuType<>(StrifeSpecibusMenu::new, FeatureFlags.VANILLA_SET));
