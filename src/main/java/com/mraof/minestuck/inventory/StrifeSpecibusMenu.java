...
public class StrifeSpecibusMenu extends AbstractContainerMenu
{
	
	private final Container inventory = new SimpleContainer(1);
	private final Player owner;
	
	public StrifeSpecibusMenu(int windowId, Inventory playerInventory)
	{
		super(MSMenuTypes.SPECIBUS_DECK.get(), windowId);
	...
	{
		ContainerHelper.addPlayerInventorySlots(this::addSlot, 9, 173, playerInventory);
		addSlot(new Slot(this.inventory, 0, 63, 73)
		{
			@Override
