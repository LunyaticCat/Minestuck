...
public class MinestuckFrFrLanguageProvider extends MinestuckLanguageProvider
{
	MinestuckFrFrLanguageProvider(DataGenerator gen)
	{
		super(gen, Minestuck.MOD_ID, "fr_fr");
	}
	
	@Override
	protected void addTranslations()
	{
		add(MSBlocks.BLACK_CHESS_DIRT, "Case d'échecs noir");
		add(MSBlocks.WHITE_CHESS_DIRT, "Case d'échecs blanche");
		add(MSBlocks.DARK_GRAY_CHESS_DIRT, "Case d'échecs gris foncé");
		add(MSBlocks.LIGHT_GRAY_CHESS_DIRT, "Case d'échecs gris clair");
		add(MSBlocks.SKAIA_PORTAL, "Portail de Skaia");
		add(MSBlocks.STONE_CRUXITE_ORE, "Minerai de cruxite");
		add(MSBlocks.COBBLESTONE_CRUXITE_ORE, "Minerai de cruxite");
		add(MSBlocks.SANDSTONE_CRUXITE_ORE, "Minerai de cruxite");
		add(MSBlocks.RED_SANDSTONE_CRUXITE_ORE, "Minerai de cruxite");
		add(MSBlocks.NETHERRACK_CRUXITE_ORE, "Minerai de cruxite");
		add(MSBlocks.END_STONE_CRUXITE_ORE, "Minerai de cruxite");
		add(MSBlocks.PINK_STONE_CRUXITE_ORE, "Minerai de cruxite");
		add(MSBlocks.STONE_URANIUM_ORE, "Minerai d'uranium");
		add(MSBlocks.COBBLESTONE_URANIUM_ORE, "Minerai d'uranium");
		add(MSBlocks.SANDSTONE_URANIUM_ORE, "Minerai d'uranium");
		add(MSBlocks.RED_SANDSTONE_URANIUM_ORE, "Minerai d'uranium");
		add(MSBlocks.NETHERRACK_URANIUM_ORE, "Minerai d'uranium");
		add(MSBlocks.END_STONE_URANIUM_ORE, "Minerai d'uranium");
		add(MSBlocks.PINK_STONE_URANIUM_ORE, "Minerai d'uranium");
		add(MSBlocks.NETHERRACK_COAL_ORE, "Minerai de charbon");
		add(MSBlocks.PINK_STONE_COAL_ORE, "Minerai de charbon");
		add(MSBlocks.SANDSTONE_IRON_ORE, "Minerai de charbon");
		add(MSBlocks.RED_SANDSTONE_IRON_ORE, "Minerai de fer");
		add(MSBlocks.END_STONE_IRON_ORE, "Minerai de fer");
		add(MSBlocks.SANDSTONE_GOLD_ORE, "Minerai d'or");
		add(MSBlocks.RED_SANDSTONE_GOLD_ORE, "Minerai d'or");
		add(MSBlocks.PINK_STONE_GOLD_ORE, "Minerai d'or");
		add(MSBlocks.END_STONE_REDSTONE_ORE, "Minerai de redstone");
		add(MSBlocks.STONE_QUARTZ_ORE, "Minerai de quartz");
		add(MSBlocks.PINK_STONE_LAPIS_ORE, "Minerai de lapis-lazuli");
		add(MSBlocks.PINK_STONE_DIAMOND_ORE, "Minerai de diamant");
		add(MSBlocks.CRUXITE_BLOCK, "Bloc de cruxite");
		add(MSBlocks.URANIUM_BLOCK, "Bloc d'uranium");
		add(MSBlocks.GENERIC_OBJECT, "Object parfaitement générique");
		add(MSBlocks.BLUE_DIRT, "Terre bleu");
		add(MSBlocks.THOUGHT_DIRT, "Terre de pensée");
		add(MSBlocks.COARSE_STONE, "Roche grossière");
		add(MSBlocks.CHISELED_COARSE_STONE, "Roche grossière taillée");
		add(MSBlocks.SHADE_BRICKS, "Pierre d'ombre taillée");
		add(MSBlocks.SMOOTH_SHADE_STONE, "Roche d'ombre lisse");
		add(MSBlocks.FROST_BRICKS, "Pierre de froid taillée");
		add(MSBlocks.FROST_TILE, "Carreau de froid");
		add(MSBlocks.CHISELED_FROST_BRICKS, "Pierre de froid sculptée");
		add(MSBlocks.CAST_IRON, "Fonte");
		add(MSBlocks.CHISELED_CAST_IRON, "Fonte taillée");
		add(MSBlocks.MYCELIUM_BRICKS, "Pierre de mycélium taillée");
		add(MSBlocks.BLACK_STONE, "Roche noir");
		add(MSBlocks.FLOWERY_MOSSY_COBBLESTONE, "Pierre moussue fleurie");
		add(MSBlocks.FLOWERY_MOSSY_STONE_BRICKS, "Pierre taillée moussue fleurie");
		add(MSBlocks.COARSE_END_STONE, "Pierre de l'End grossière");
		add(MSBlocks.END_GRASS, "Herbe de l'End");
		add(MSBlocks.CHALK, "Craie");
		add(MSBlocks.POLISHED_CHALK, "Craie polie");
		add(MSBlocks.CHALK_BRICKS, "Craie taillée");
		add(MSBlocks.CHISELED_CHALK_BRICKS, "Craie sculptée");
		add(MSBlocks.PINK_STONE, "Pierre rose");
		add(MSBlocks.POLISHED_PINK_STONE, "Pierre rose polie");
		add(MSBlocks.PINK_STONE_BRICKS, "Pierre rose taillée");
		add(MSBlocks.CHISELED_PINK_STONE_BRICKS, "Pierre rose sculptée");
		add(MSBlocks.CRACKED_PINK_STONE_BRICKS, "Pierre rose taillée craquelée");
		add(MSBlocks.MOSSY_PINK_STONE_BRICKS, "Pierre rose taillée moussue");
		add(MSBlocks.DENSE_CLOUD, "Nuage dense");
		add(MSBlocks.BRIGHT_DENSE_CLOUD, "Nuage dance brillant");
		add(MSBlocks.SUGAR_CUBE, "Cube de sucre");
		add(MSBlocks.GLOWING_LOG, "Bûche lumineuse");
		add(MSBlocks.FROST_LOG, "Bûche de froid");
		add(MSBlocks.RAINBOW_LOG, "Bûche d'arc-en-ciel");
		add(MSBlocks.END_LOG, "Bûche de l'end");
		add(MSBlocks.VINE_LOG, "Bûche de chêne grimpant");
		add(MSBlocks.FLOWERY_VINE_LOG, "Bûche de chêne grimpant fleurie");
		add(MSBlocks.DEAD_LOG, "Bûche morte");
		add(MSBlocks.PETRIFIED_LOG, "Bûche pétrifié");
		add(MSBlocks.GLOWING_WOOD, "Bois lumineux");
		add(MSBlocks.FROST_WOOD, "Bois de froid");
		add(MSBlocks.RAINBOW_WOOD, "Bois d'arc-en-ciel");
		add(MSBlocks.END_WOOD, "Bois de l'end");
		add(MSBlocks.VINE_WOOD, "Bois de chêne grimpant");
		add(MSBlocks.FLOWERY_VINE_WOOD, "Bois de chêne grimpant fleurie");
		add(MSBlocks.DEAD_WOOD, "Bois mort");
		add(MSBlocks.PETRIFIED_WOOD, "Bois pétrifié");
		add(MSBlocks.GLOWING_PLANKS, "Planches lumineuses");
		add(MSBlocks.FROST_PLANKS, "Planches de froid");
		add(MSBlocks.RAINBOW_PLANKS, "Planches d'arc-en-ciel");
		add(MSBlocks.END_PLANKS, "Planches de l'end");
		add(MSBlocks.DEAD_PLANKS, "Planches mortes");
		add(MSBlocks.TREATED_PLANKS, "Planches traitée");
		add(MSBlocks.FROST_LEAVES, "Feuilles de froid");
		add(MSBlocks.RAINBOW_LEAVES, "Feuilles d'arc-en-ciel");
		add(MSBlocks.END_LEAVES, "Feuilles de l'End");
		add(MSBlocks.RAINBOW_SAPLING, "Pousse d'arc-en-ciel");
		add(MSBlocks.END_SAPLING, "Pousse de l'End");
		add(MSBlocks.BLOOD_ASPECT_LOG, "Bûche de sang");
		add(MSBlocks.BREATH_ASPECT_LOG, "Bûche de souffle");
		add(MSBlocks.DOOM_ASPECT_LOG, "Bûche de ruine");
		add(MSBlocks.HEART_ASPECT_LOG, "Bûche de cœur");
		add(MSBlocks.HOPE_ASPECT_LOG, "Bûche d'espoir");
		add(MSBlocks.LIFE_ASPECT_LOG, "Bûche de vie");
		add(MSBlocks.LIGHT_ASPECT_LOG, "Bûche de lumière");
		add(MSBlocks.MIND_ASPECT_LOG, "Bûche d'esprit");
		add(MSBlocks.RAGE_ASPECT_LOG, "Bûche de rage");
		add(MSBlocks.SPACE_ASPECT_LOG, "Bûche d'espace");
		add(MSBlocks.TIME_ASPECT_LOG, "Bûche de temps");
		add(MSBlocks.VOID_ASPECT_LOG, "Bûche de vide");
		add(MSBlocks.BLOOD_ASPECT_PLANKS, "Planches de sang");
		add(MSBlocks.BREATH_ASPECT_PLANKS, "Planches de souffle");
		add(MSBlocks.DOOM_ASPECT_PLANKS, "Planches de ruine");
		add(MSBlocks.HEART_ASPECT_PLANKS, "Planches de cœur");
		add(MSBlocks.HOPE_ASPECT_PLANKS, "Planches d'espoir");
		add(MSBlocks.LIFE_ASPECT_PLANKS, "Planches de vie");
		add(MSBlocks.LIGHT_ASPECT_PLANKS, "Planches de lumière");
		add(MSBlocks.MIND_ASPECT_PLANKS, "Planches d'esprit");
		add(MSBlocks.RAGE_ASPECT_PLANKS, "Planches de rage");
		add(MSBlocks.SPACE_ASPECT_PLANKS, "Planches d'espace");
		add(MSBlocks.TIME_ASPECT_PLANKS, "Planches de temps");
		add(MSBlocks.VOID_ASPECT_PLANKS, "Planches de vide");
		add(MSBlocks.BLOOD_ASPECT_LEAVES, "Feuilles de sang");
		add(MSBlocks.BREATH_ASPECT_LEAVES, "Feuilles de souffle");
		add(MSBlocks.DOOM_ASPECT_LEAVES, "Feuilles de ruine");
		add(MSBlocks.HEART_ASPECT_LEAVES, "Feuilles de cœur");
		add(MSBlocks.HOPE_ASPECT_LEAVES, "Feuilles d'espoir");
		add(MSBlocks.LIFE_ASPECT_LEAVES, "Feuilles de vie");
		add(MSBlocks.LIGHT_ASPECT_LEAVES, "Feuilles de lumière");
		add(MSBlocks.MIND_ASPECT_LEAVES, "Feuilles d'esprit");
		add(MSBlocks.RAGE_ASPECT_LEAVES, "Feuilles de rage");
		add(MSBlocks.SPACE_ASPECT_LEAVES, "Feuilles d'espace");
		add(MSBlocks.TIME_ASPECT_LEAVES, "Feuilles de temps");
		add(MSBlocks.VOID_ASPECT_LEAVES, "Feuilles de vide");
		add(MSBlocks.BLOOD_ASPECT_SAPLING, "Pousse de sang");
		add(MSBlocks.BREATH_ASPECT_SAPLING, "Pousse de souffle");
		add(MSBlocks.DOOM_ASPECT_SAPLING, "Pousse de ruine");
		add(MSBlocks.HEART_ASPECT_SAPLING, "Pousse de cœur");
		add(MSBlocks.HOPE_ASPECT_SAPLING, "Pousse d'espoir");
		add(MSBlocks.LIFE_ASPECT_SAPLING, "Pousse de vie");
		add(MSBlocks.LIGHT_ASPECT_SAPLING, "Pousse de lumière");
		add(MSBlocks.MIND_ASPECT_SAPLING, "Pousse d'esprit");
		add(MSBlocks.RAGE_ASPECT_SAPLING, "Pousse de rage");
		add(MSBlocks.SPACE_ASPECT_SAPLING, "Pousse d'espace");
		add(MSBlocks.TIME_ASPECT_SAPLING, "Pousse de temps");
		add(MSBlocks.VOID_ASPECT_SAPLING, "Pousse de vide");
		addTooltip(MSBlocks.BLOOD_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.BREATH_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.DOOM_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.HEART_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.HOPE_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.LIFE_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.LIGHT_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.MIND_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.RAGE_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.SPACE_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.TIME_ASPECT_SAPLING, "Pas encore implémenté");
		addTooltip(MSBlocks.VOID_ASPECT_SAPLING, "Pas encore implémenté");
		add(MSBlocks.GLOWING_MUSHROOM, "Champignon lumineux");
		addStoreTooltip(MSBlocks.GLOWING_MUSHROOM, "Ce champignon as un goût un peu meilleur que tous les autres par ici, selon moi!");
		add(MSBlocks.DESERT_BUSH, "Arbuste du desert");
		add(MSBlocks.BLOOMING_CACTUS, "Cactus en floraison");
		add(MSBlocks.PETRIFIED_GRASS, "Herbe pétrifié");
		add(MSBlocks.PETRIFIED_POPPY, "Coquelicot pétrifié");
		add(MSBlocks.STRAWBERRY, "Fraise");
		add(MSBlocks.ATTACHED_STRAWBERRY_STEM, "Queue de fraise attaché");
		add(MSBlocks.STRAWBERRY_STEM, "Queue de fraise");
		add(MSBlocks.GLOWY_GOOP, "Substance visqueuse rayonnante");
		add(MSBlocks.COAGULATED_BLOOD, "Sang coagulé");
		add(MSBlocks.VEIN, "Veine");
		add(MSBlocks.VEIN_CORNER, "Veine");
		addTooltip(MSBlocks.VEIN_CORNER, "Coin");
		add(MSBlocks.INVERTED_VEIN_CORNER, "Veine");
		addTooltip(MSBlocks.INVERTED_VEIN_CORNER, "Coin (Écoulement inversé)");
		add(MSBlocks.COARSE_STONE_STAIRS, "Escalier de pierre grossière");
		add(MSBlocks.SHADE_BRICK_STAIRS, "Escalier de pierre d'ombre taillée");
		add(MSBlocks.FROST_BRICK_STAIRS, "Escalier de pierre de froid taillée");
		add(MSBlocks.CAST_IRON_STAIRS, "Escalier en fonte");
		add(MSBlocks.MYCELIUM_BRICK_STAIRS, "Escalier de briques de Mycélium");
		add(MSBlocks.CHALK_STAIRS, "Escalier de craie");
		add(MSBlocks.CHALK_BRICK_STAIRS, "Escalier de craie taillée");
		add(MSBlocks.PINK_STONE_BRICK_STAIRS, "Escalier de pierre rose taillée");
		add(MSBlocks.RAINBOW_PLANKS_STAIRS, "Escalier de planches d'arc-en-ciel");
		add(MSBlocks.END_PLANKS_STAIRS, "Escalier de planches de l'End");
		add(MSBlocks.DEAD_PLANKS_STAIRS, "Escalier de planches mortes");
		add(MSBlocks.TREATED_PLANKS_STAIRS, "Escalier de planches traitées");
		add(MSBlocks.CHALK_SLAB, "Dalle de craie");
		add(MSBlocks.CHALK_BRICK_SLAB, "Dalle de craie taillée");
		add(MSBlocks.PINK_STONE_BRICK_SLAB, "Dalle de pierre rose taillée");
		add(MSBlocks.RAINBOW_PLANKS_SLAB, "Dalle de planches d'arc-en-ciel");
		add(MSBlocks.END_PLANKS_SLAB, "Dalle de planches de l'End");
		add(MSBlocks.DEAD_PLANKS_SLAB, "Dale de planches mortes");
		add(MSBlocks.TREATED_PLANKS_SLAB, "Dale de planches traitées");
		add(MSBlocks.GATE, "Portail");
		add(MSBlocks.RETURN_NODE, "Point de retour");
		MSBlocks.CRUXTRUDER.forEachBlock(block -> add(block, "Cruxtrudeur"));
		add(MSBlocks.CRUXTRUDER_LID, "Couvercle de cruxtrudeur");
		MSBlocks.TOTEM_LATHE.forEachBlock(block -> add(block, "Tourneur de totems"));
		MSBlocks.ALCHEMITER.forEachBlock(block -> add(block, "Alchimiseur"));
		MSBlocks.PUNCH_DESIGNIX.forEachBlock(block -> add(block, "Punch Designix"));
		add(MSBlocks.HOLOPAD, "Holopad");
		add(MSBlocks.MINI_CRUXTRUDER, "Cruxtrudeur miniature");
		add(MSBlocks.MINI_TOTEM_LATHE, "Tourneur de totems miniature");
		add(MSBlocks.MINI_ALCHEMITER, "Alchimiseur miniature");
		add(MSBlocks.MINI_PUNCH_DESIGNIX, "Punch Designix miniature");
		add(MSBlocks.COMPUTER, "Ordinateur SBURB");
		add(MSBlocks.LAPTOP, "Laptop");
		add(MSBlocks.CROCKERTOP, "Crockertop");
		add(MSBlocks.HUBTOP, "Hubtop");
		add(MSBlocks.LUNCHTOP, "Repatop");
		add(MSBlocks.TRANSPORTALIZER, "Transportalizer");
		add(MSBlocks.GRIST_WIDGET, "GristWidget 12000");
		add(MSBlocks.URANIUM_COOKER, "Cuisinalyzer");
		add(MSBlocks.CRUXITE_DOWEL, "Totem en cruxite");
		add(MSBlocks.GOLD_SEEDS, "Graines dorées");
		addTooltip(MSBlocks.GOLD_SEEDS, "Ces graines sont faites d'or 24 carats !");
		addStoreTooltip(MSBlocks.GOLD_SEEDS, "Tu aime les graines normales? C'est leur version luxueuse!");
		add(MSBlocks.WOODEN_CACTUS, "Cactus en bois");
		add(MSBlocks.APPLE_CAKE, "Gâteau à la pomme");
		addStoreTooltip(MSBlocks.APPLE_CAKE, "Les gâteaux sont vraiment les meilleurs quand ils sont à base de pommes!");
		add(MSBlocks.BLUE_CAKE, "Gâteau bleu");
		addStore(MSBlocks.BLUE_CAKE, "Un Gâteau froid?");
		addStoreTooltip(MSBlocks.BLUE_CAKE, "Fait attention avec ça. Cela pourrait être un gâteau de froid. Une bouchée et il te congélera mieux que le fait se temps.");
		add(MSBlocks.COLD_CAKE, "Gâteau très froid");
		addStore(MSBlocks.COLD_CAKE, "Un Gâteau bleu?");
		addStoreTooltip(MSBlocks.COLD_CAKE, "C'est bleu, donc je suis assez convincu que se doit être le légendaire gateau bleu. Il est dit qu'il te fait bouger!");
		add(MSBlocks.RED_CAKE, "Gâteau rouge");
		addStore(MSBlocks.RED_CAKE, "Un gâteau brulant?");
		addStoreTooltip(MSBlocks.RED_CAKE, "Fait une farce à tes amis avec se gâteau extrêmement chaud!");
		add(MSBlocks.HOT_CAKE, "Gâteau très chaud");
		addStore(MSBlocks.HOT_CAKE, "Un gâteau rouge?");
		addStoreTooltip(MSBlocks.HOT_CAKE, "Sais tu que les gâteaux rouges peuvent te soigner? Je suis sur à 90%% que c'est un de ces gâteaux.");
		add(MSBlocks.REVERSE_CAKE, "Gâteau inversé");
		add(MSBlocks.FUCHSIA_CAKE, "Gâteau fuchsia");
		add(MSBlocks.NEGATIVE_CAKE, "Gâteau negatif");
		addStore(MSBlocks.FUCHSIA_CAKE, "Gâteau fuchsia");
		add(MSBlocks.PRIMED_TNT, "TNT amorcée");
		add(MSBlocks.UNSTABLE_TNT, "TNT instable");
		add(MSBlocks.INSTANT_TNT, "TNT instantanée");
		add(MSBlocks.WOODEN_EXPLOSIVE_BUTTON, "Button en TNT");
		add(MSBlocks.STONE_EXPLOSIVE_BUTTON, "Button en TNT");
		add(MSBlocks.BLENDER, "Mixeur");
		add(MSBlocks.CHESSBOARD, "Échiquier");
		add(MSBlocks.MINI_FROG_STATUE, "Réplique de statue de grenouille");
		addStoreTooltip(MSBlocks.MINI_FROG_STATUE, "Certains disent que c'est effrayant, certains disent que c'est mignon, d'autres diraient que c'est de la contrebande, donc garder le à l'écart!");
		add(MSBlocks.GLOWYSTONE_DUST, "Poudre brillante");
		add(MSBlocks.OIL, "Pétrole");
		add(MSBlocks.BLOOD, "Sang");
		add(MSBlocks.BRAIN_JUICE, "Jus de cerveau");
		add(MSBlocks.WATER_COLORS, "Peinture");
		add(MSBlocks.ENDER, "Fluide d'end");
		add(MSBlocks.LIGHT_WATER, "Eau claire");
		
		add(MSItems.CLAW_HAMMER, "Marteau arrache-clous");
		addTooltip(MSItems.CLAW_HAMMER, "Un marteau commun que l'on trouve dans n'importe quel garage. Il peut aussi détruire des blocs");
		add(MSItems.SLEDGE_HAMMER, "Masse");
		addTooltip(MSItems.SLEDGE_HAMMER, "Un assez grand, bien que commun, marteau. Il peut aussi détruire des blocs");
		add(MSItems.BLACKSMITH_HAMMER, "Marteau de forgeron");
		addTooltip(MSItems.BLACKSMITH_HAMMER, "Un marteau solide qui l'on trouve d'habitude dans une forge. Il peut aussi détruire des blocs");
		add(MSItems.POGO_HAMMER, "Marteau pogo");
		addTooltip(MSItems.POGO_HAMMER, "Un marteau visqueux avec la capacité de rebondir sur les ennemies. Il peut aussi détruire des blocs");
		add(MSItems.WRINKLEFUCKER, "Fer à défoncer");
		addTooltip(MSItems.WRINKLEFUCKER, "Y a-t-il quelque chose de plus iconique?");
		add(MSItems.TELESCOPIC_SASSACRUSHER, "Sassacraseur télescopique");
		addTooltip(MSItems.TELESCOPIC_SASSACRUSHER, "OH ho! Le marteau parfait pour un élégant jeune homme qui aime les facéties et les bonnes réserves de grist!");
		add(MSItems.REGI_HAMMER, "RegiMarteau");
		add(MSItems.FEAR_NO_ANVIL, "Brise toutes enclumes");
		addTooltip(MSItems.FEAR_NO_ANVIL, "De quoi peut on avoir peur quand on est en possession d'un truc pareil? Se super marteau peut détruire des blocs et faire des dégâts massifs.");
		//TODO Continuer traduction
