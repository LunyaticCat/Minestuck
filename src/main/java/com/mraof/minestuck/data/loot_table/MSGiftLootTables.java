	...
	public void accept(BiConsumer<ResourceLocation, LootTable.Builder> lootProcessor)
	{
		...
		lootProcessor.accept(MSLootTables.CONSORT_GENERAL_STOCK, LootTable.builder()
				.addLootPool(LootPool.builder().name(ITEM_POOL).rolls(ConstantRange.of(4))
						...
						.addEntry(ItemLootEntry.builder(MSBlocks.STONE_MINI_FROG_STATUE).weight(8).acceptFunction(SetCount.builder(RandomValueRange.of(1, 5))))
						...
						.addEntry(ItemLootEntry.builder(MSItems.ACE_OF_CLUBS).weight(2).acceptCondition(ConsortLootCondition.builder(EnumConsort.SALAMANDER)))
						.addEntry(ItemLootEntry.builder(MSItems.ACE_OF_SPADES).weight(2).acceptCondition(ConsortLootCondition.builder(EnumConsort.NAKAGATOR)))
						.addEntry(ItemLootEntry.builder(MSItems.ACE_OF_HEARTS).weight(2).acceptCondition(ConsortLootCondition.builder(EnumConsort.TURTLE)))
						.addEntry(ItemLootEntry.builder(MSItems.ACE_OF_DIAMONDS).weight(2).acceptCondition(ConsortLootCondition.builder(EnumConsort.IGUANA)))
		...
		lootProcessor.accept(locationFor(LandTypes.SAND, MSLootTables.CONSORT_FOOD_STOCK), LootTable.builder()
				.addLootPool(LootPool.builder().name(MAIN_POOL).rolls(ConstantRange.of(1))
						...
						.addEntry(ItemLootEntry.builder(Items.POTION).weight(8).acceptFunction(SetCount.builder(RandomValueRange.of(3, 6))).acceptFunction(SetNBT.builder(waterNBT())))
